...
const api = ["/search", "/estimate", "/photos", "/runs", "/debug", "/learn/", "/chat", "/health", "/training/"];
...
const cleanUrls = () => ({
  ...
  configureServer(server) {
    const map = { "/playground": "/playground.html", "/learn": "/learn.html", "/suggestions": "/suggestions.html", "/training": "/training.html" };
